...
<div class="container">
    ...
    @method('PATCH')
        ...
        <div class="form-group row">
            ...
            <textarea name="url" id="" cols="30" rows="5" class="form-control @error('url') is-invalid @enderror"
             name="url"
             
             autocomplete="url" autofocus>{{ old('url') ?? $user->profile->url }}</textarea>
